...
IL_0059:
	{
		...
		NullCheck(L_15);
		int32_t L_21;
		L_21 = VirtualFuncInvoker1< int32_t, RuntimeObject* >::Invoke(20 /* System.Int32 System.Collections.ArrayList::Add(System.Object) */, L_15, L_20);
		int32_t L_22 = V_4;
...
IL_0072:
	...
	}
	{
		...
		NullCheck(L_26);
		RuntimeArray* L_29;
		L_29 = VirtualFuncInvoker1< RuntimeArray*, Type_t* >::Invoke(34 /* System.Array System.Collections.ArrayList::ToArray(System.Type) */, L_26, L_28);
...
IL_0015:
	{
		...
		Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* L_5 = ___0_baseUri;
		NullCheck(L_5);
		UriParser_t920B0868286118827C08B08A15A9456AF6C19D81* L_6 = L_5->___m_Syntax_18;
		NullCheck(L_6);
		bool L_7;
...
IL_003c:
	{
		...
		NullCheck(L_14);
		UriParser_t920B0868286118827C08B08A15A9456AF6C19D81* L_15 = L_14->___m_Syntax_18;
...
IL_002d:
	{
		UriParser_t920B0868286118827C08B08A15A9456AF6C19D81* L_7 = __this->___m_Syntax_18;
...
IL_0048:
	{
		...
		UriParser_t920B0868286118827C08B08A15A9456AF6C19D81* L_15 = L_14->___m_Syntax_18;
		NullCheck(L_15);
		String_t* L_16 = L_15->___m_Scheme_8;
		bool L_17;
